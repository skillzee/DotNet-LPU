...
namespace University_Course_Registration_System
{
    ...
    public class UniversitySystem
    {
        ...
        public void DisplayAllCourses()
        {
            ...
            {
                Console.WriteLine($"Course Code -> {item.Key}");
                Console.WriteLine($"Course Name -> {item.Value.CourseName}");
                Console.WriteLine($"Course Credits -> {item.Value.Credits}");
                Console.WriteLine($"Course MaxCapacity -> {item.Value.MaxCapacity}");
            }
        ...
        public void DisplaySystemSummary()
        {
            ...
            Console.WriteLine($"Average Enrollment -> {AvailableCourses.Count() / Students.Count()}");
